        ...
        <div className="flex items-center justify-between px-6 h-16">
          <div className="flex items-center gap-3">
             <div className="relative">
                <img src="/profile.jpg" alt="Profile" className="w-10 h-10 rounded-full object-cover border-2 border-primary/20" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 pb-32 flex flex-col lg:flex-row gap-12 relative">
        ...
        <main className="flex-1 min-w-0">
           ...
           <div className={`${activeTab === 'profile' ? 'block animate-slide-up' : 'hidden'} lg:hidden`}>
              <Card className="bg-card/40 border-border backdrop-blur-xl shadow-2xl mb-8">
                 <CardContent className="p-8 text-center">
                    <div className="relative inline-block mb-8">
                        <img src="/profile.jpg" alt="Profile" className="w-48 h-48 mx-auto rounded-full object-cover border-8 border-primary/10 shadow-2xl" />
                    ...
                    <div className="grid grid-cols-1 gap-4 text-start bg-muted/20 p-6 rounded-[2rem] border border-border/50 backdrop-blur-sm">
                       <div className="flex items-center gap-4 p-3 rounded-2xl bg-background/40">
                          <div className="p-3 rounded-xl bg-primary/10 border border-primary/20"><Mail className="w-6 h-6 text-primary" /></div>
                       ...
                       {frontmatter.phone && (
                          <div className="flex items-center gap-4 p-3 rounded-2xl bg-background/40">
                             <div className="p-3 rounded-xl bg-primary/10 border border-primary/20"><Phone className="w-6 h-6 text-primary" /></div>
                             <div className="flex flex-col min-w-0">
                       ...
                       <div className="flex items-center gap-4 p-3 rounded-2xl bg-background/40">
                          <div className="p-3 rounded-xl bg-primary/10 border border-primary/20"><MapPin className="w-6 h-6 text-primary" /></div>
                          <div className="flex flex-col min-w-0">
           ...
           <div className={`${activeTab === 'experience' ? 'block animate-slide-up' : 'hidden'} lg:block`}>
              <Card className="bg-card/40 border-border backdrop-blur-xl shadow-2xl transition-all duration-500">
           ...
           <div className={`${activeTab === 'settings' ? 'block animate-slide-up' : 'hidden'} lg:hidden`}>
              <Card className="bg-card/40 border-border backdrop-blur-xl shadow-2xl">
